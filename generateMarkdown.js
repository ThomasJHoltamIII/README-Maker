...
function renderLicenseBadge(license) {
  ...
  return `[![License Badge](https://img.shields.io/badge/License-${license}-blue.svg)](${renderLicenseLink(license)})`;
}
...
function generateMarkdown(data) {
  const { title, description, installation, usage, license, gitHubLink, email, tests, author } = data;
